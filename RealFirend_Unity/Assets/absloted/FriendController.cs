...
public class FriendController : MonoBehaviour
{
    ...
    {
        ReachObject(GameObject.Find("Dummy").GetComponentInChildren<aszVRMBodyInfo>().GetSupportJoints.LeftCheek.gameObject);
    }
    ...
    {
        TouchObject(GameObject.Find("Dummy").GetComponentInChildren<aszVRMBodyInfo>().GetSupportJoints.LeftCheek.gameObject);
    }
    ...
    public void SitOnObject(aszSitable sitObj)
    {
    ...
    {
        KissObject(GameObject.Find("Dummy").GetComponentInChildren<aszVRMBodyInfo>().GetSupportJoints.HeadCenter.gameObject, GameObject.Find("Dummy").GetComponentInChildren<aszHoldable>());
    }
    public void KissObject(GameObject kissObj, aszHoldable holdObj)
    {
    ...
    IEnumerator KissingObjectWhileHolding(GameObject kissObj, aszHoldable holdObj)
    {
        YieldInstruction wait = new WaitForEndOfFrame();
    ...
    {
        HoldObject(GameObject.Find("Dummy").GetComponentInChildren<aszHoldable>());
    }
    public void HoldObject(aszHoldable holdObj)
    {
        StartCoroutine(HoldingObject(holdObj));
    }
    IEnumerator HoldingObject(aszHoldable holdObj)
    {
        YieldInstruction wait = new WaitForEndOfFrame();
    ...
    {
        HugObject(GameObject.Find("Dummy").GetComponentInChildren<aszHugable>());
    }
    public void HugObject(aszHugable hugObj)
    {
