...
public class BodyStatus : MonoBehaviour
{
    ...
    [SerializeField] private BodyFootController m_LeftBodyFootStatus, m_RightBodyFootStatus;
    [SerializeField] private BodyToesController m_LeftBodyToesStatus, m_RightBodyToesStatus;

    [Header("Status")]
    [SerializeField]private Holdable m_HoldingObj; public Holdable HoldingObj { get { return m_HoldingObj; } set { m_HoldingObj = value; } }
    [SerializeField]private Hugable m_HugingObj; public Hugable HugingObj { get { return m_HugingObj; } set { m_HugingObj = value; } }
    ...
    {
        m_BodyInfo = GetComponent<BodyInfo>();
        Init();
    }
    ...
    private void Init()
    {
        ...
        m_LeftBodyFootStatus = m_BodyInfo.GetHumanoid.LeftFoot.AddComponent<BodyFootController>();
        m_RightBodyFootStatus = m_BodyInfo.GetHumanoid.RightFoot.AddComponent<BodyFootController>();
        m_LeftBodyToesStatus = m_BodyInfo.GetHumanoid.LeftToes.AddComponent<BodyToesController>();
        m_RightBodyToesStatus = m_BodyInfo.GetHumanoid.RightToes.AddComponent<BodyToesController>();
    ...
    {
        SphereCollider tmpCollider = target.AddComponent<SphereCollider>();
